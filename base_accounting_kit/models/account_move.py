...
class AccountMove(models.Model):
    ...
    transporter_id = fields.Many2one('account.transporter', string='Transporter')
...
# Transporter model for suggestive field
class AccountTransporter(models.Model):
    _name = 'account.transporter'
    _description = 'Transporter'

    name = fields.Char(string='Transporter Name', required=True, index=True)
